...
// Simple floating decorations for track pages
</script>

<template>
  <ClientOnly>
    <!-- Sword -->
    <div class="fixed top-20 right-10 animate-float opacity-10 pointer-events-none" aria-hidden="true">
    ...
    <!-- Shield -->
    <div class="fixed bottom-40 left-10 animate-swing opacity-10 pointer-events-none" aria-hidden="true">
