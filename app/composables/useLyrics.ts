...
const localLyricsData: Record<number, LyricLine[]> = {
  ...
  106: [
    ...
    { time: 39, text: 'Un vieux monsieur s\'avance,' },
    ...
    { time: 150, text: 'Gaïa ne nous a pas choisi' },
    { time: 152, text: 'OOOH ! Vive Chicout\', vive Chicout\' !' },
    { time: 156, text: 'Vive Chicout\' l\'hiver !' },
    { time: 160, text: 'Qui s\'en prend derrière, devant !' },
    { time: 162, text: 'Louis en garde un goût amer !' },
    { time: 166, text: 'OOOH ! Vive Chicout\', vive Chicout\' !' },
