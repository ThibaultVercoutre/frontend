...
const localLyricsData: Record<number, LyricLine[]> = {
  ...
  2: [
    { time: 0, text: '...' },
    { time: 0, text: 'Cette soldate dont nous avons parlé' },
    { time: 13, text: 'Ses grands exploits, nous les avons comptés' },
    { time: 18, text: 'Mais à présent, il nous faut esquisser' },
    { time: 23, text: 'Son corps mythique à la noble beauté' },
    { time: 30, text: 'Ni des chansons, ni des contes, ni des fables' },
    { time: 32, text: 'Nous n\'avions vu femme aussi redoutable' },
    { time: 35, text: 'De qu\'un pays, de France et de Navarre' },
    { time: 37, text: 'Une soldate n\'égale à son fier charme' },
    { time: 40, text: 'Ses doux cheveux semblant à des fils d\'or' },
    { time: 42, text: 'Une fois lâchés, lui caressent les épaules' },
    { time: 45, text: 'De tous les êtres que la nature façonne' },
    { time: 48, text: 'Je vous assure qu\'elle en est la plus bonne' },
    { time: 50, text: 'Son beau visage, au teint clair lumineux' },
    { time: 53, text: 'Ne rivalise qu\'avec ses douze yeux bleus' },
    { time: 55, text: 'Ce bleu marin, chatoyant tel un feu' },
    { time: 58, text: 'Révèle sa rage, un courage' },
    { time: 59, text: 'Un courage, un courage' },
    { time: 59, text: 'Un courage merveilleux' },
    { time: 60, text: 'Son éparpillé, les gants délicats' },
    { time: 63, text: 'Est un trésor que mère nature créa' },
    { time: 65, text: 'Et ses lèvres charnues sont un régal' },
    { time: 68, text: 'Pour qui aime pratiquer le sexe oral' },
    { time: 71, text: 'Gabriel, ton corps s\'embrase de beauté' },
    { time: 74, text: 'Gabriel, les hommes se prosternent à tes quiquets' },
    { time: 76, text: 'Car tu détiens le pouvoir de les dominer' },
    { time: 79, text: 'Gabriel, les bises tu fais lever' },
    { time: 81, text: 'Gabriel, si le désir n\'existait pas' },
    { time: 84, text: 'Gabriel, grâce à ton corps tu le créas' },
    { time: 86, text: 'Car la gaule est conquise, rien qu\'à te voir' },
    { time: 89, text: 'Gabriel, tu es le plus beau homme de la vie' },
    { time: 89, text: 'Gabriel, les bises s\'élèvent haut devant toi' },
    { time: 92, text: 'Il me faut m\'attarder à présent sur sa gorge' },
    { time: 97, text: 'Que dis-je, ce gour, cette montagne dévot' },
    { time: 99, text: 'Je suis dure à monter, si bonne à sauter' },
    { time: 102, text: 'Gabriel est la reine des décolletés' },
    { time: 104, text: 'J\'aimerais la toucher, la sentir dans mes mains' },
    { time: 107, text: 'Cette chair opulente qui lui forme ses seins' },
    { time: 109, text: 'Ils sont assurément de la main d\'un divin' },
    { time: 112, text: 'Ou du moins, il était sculpté par Odin' },
    { time: 114, text: 'Je vous prie de me laisser admirer' },
    { time: 116, text: 'Saigner son ventre et sa taille si musclée' },
    { time: 119, text: 'C\'est la vie, c\'est la vie, c\'est la vie' },
    { time: 119, text: 'Ses abdos forts, sa chute de reins courbés' },
    { time: 121, text: 'Qui nous mène droit vers l\'entre-désirée' },
    { time: 124, text: 'Je ne pourrais vous décrire à quel point' },
    { time: 127, text: 'Elle a un si beau, si joli vagin' },
    { time: 129, text: 'Les mots me manquent pour ce portail plus bien' },
    { time: 132, text: 'Qui a vu tant de monde qui semble sans fin' },
    { time: 135, text: 'Gabriel, ton corps s\'embrase de beauté' },
    { time: 137, text: 'Gabriel, les hommes se prosternent à tes pieds' },
    { time: 140, text: 'Car tu détiens le pouvoir de les dominer' },
    { time: 142, text: 'Gabriel, les bises tu fais lever' },
    { time: 145, text: 'Gabriel, si le désir n\'existait pas' },
    { time: 147, text: 'Gabriel, grâce à ton corps tu le créas' },
    { time: 149, text: 'Car la Gaule est conquise rien qu\'à te voir' },
    { time: 153, text: 'Gabriel, les bises s\'élèvent devant toi' },
    { time: 156, text: 'Gabriel, ton corps est ardent' },
    { time: 161, text: 'Comme le feu des enfers' },
    { time: 164, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 178, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 179, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 179, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 179, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 179, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 179, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    ...
    { time: 179, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 179, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 180, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 180, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 180, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 180, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 180, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    ...
    { time: 180, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 180, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
    { time: 210, text: 'Gabriel, ton corps est celui d\'une femme militaire' },
  ],
  3: [
    { time: 0, text: '...' },
    { time: 14, text: 'Aujourd\'hui, attaquons-nous à une majorité de minorités' },
    { time: 21, text: 'Je pense que vous savez déjà de qui nous allons parler' },
    { time: 27, text: 'Je parle bien sûr de tous ces petits fils de putes' },
    { time: 34, text: 'Vivement qu\'on leur mette des culbutes' },
    { time: 38, text: 'Ils sont là à gueuler dans les manifs, enfin on devrait plutôt dire "iels"' },
    { time: 43.5, text: 'Ça a des combats insignifiants, débiles, idiots et superficiels' },
    { time: 47, text: 'Trop occupés à oublier de se raser que de réviser leur cours de SVT' },
    { time: 51, text: 'S\'il vous plaît, retournez à l\'école et quittez votre minorité' },
    { time: 56, text: 'Les LGBTQIA+, ces grands fous' },
    { time: 60, text: 'T\'es une fille quand t\'as une zaza, t\'es un garçon quand t\'as un zouzou' },
    { time: 64, text: 'Arrêtez de nous faire chier avec tous vos genres qui sortent de la binarité' },
    { time: 67, text: 'Les LGBTQIA+, ces grands fous' },
    { time: 70, text: 'Évidemment, nous savons que vous n\'avez rien sous le caillou' },
    { time: 74, text: 'Mais s\'il vous plaît, ayez un minimum de civilité' },
    { time: 79, text: 'Woke, mais qu\'est-ce que ça veut dire ?' },
    { time: 83, text: 'Ça fait maintenant 30 ans que ce mot existe' },
    { time: 85, text: 'Est-ce un mot dans la langue de Shakespeare ?' },
    { time: 87, text: 'Ces connards se prennent pour des linguistes' },
    { time: 89, text: 'D\'après eux, c\'est être conscient des problèmes sociétaux' },
    { time: 92, text: 'Liés à la justice sociale et à l\'égalité raciale' },
    { time: 95, text: 'Mais déjà ça, on discerne quelque chose de pas trop réglo' },
    { time: 99, text: 'Pour eux, ils séparent les noirs, les arabes et les gens normaux' },
    { time: 102, text: 'Alors excusez-moi, bande de gros gauchos, bande d\'enculés' },
    { time: 106, text: 'Pendant que vous vous battez pour assembler les gens différents' },
    { time: 109, text: 'Nous les fachos, on se bat pour mettre en lumière cette multiculturalité' },
    { time: 113, text: 'Alors que vous vous cachez souillés, brutalisez la culture des gens' },
    { time: 118, text: 'Les LGBTQIA+, ces grands fous' },
    { time: 122, text: 'T\'es une fille quand t\'as une zaza, t\'es un garçon quand t\'as un zouzou' },
    { time: 126, text: 'Arrêtez de nous faire chier avec tous vos genres qui sortent de la binarité' },
    { time: 130, text: 'Les LGBTQIA+, ces grands fous' },
    { time: 133, text: 'Évidemment, nous savons que vous n\'avez rien sous le caillou' },
    { time: 137, text: 'Mais s\'il vous plaît, ayez un minimum de civilité' },
    { time: 141, text: 'Après les woke, parlons de hommes déconstruits' },
    { time: 146, text: 'Mais la seule chose qui est déconstruite chez moi, c\'est ta mère' },
    { time: 150, text: 'Car l\'idée d\'aller à la cuisine, la penderie et la laverie' },
    { time: 154, text: 'Ça me donne assurément un énorme mal de mer' },
    { time: 158, text: 'Vous n\'arrêtez pas de nous faire chier avec la galanterie' },
    { time: 161, text: 'On paie le resto, ne vous étonnez pas de perdre 20% de votre salaire' },
    { time: 165, text: 'Si vous voulez qu\'on soit déconstruits, soyez-le vous-même aussi' },
    { time: 168.5, text: 'Y\'en aura le bol de perdre l\'argent, tout ça pour aucune récompense derrière' },
    { time: 172, text: 'Nous, ce qu\'on veut, c\'est se faire plaisir' },
    { time: 174, text: 'Mais attention, y\'a des limites' },
    { time: 176, text: 'Les poils, c\'est non ! Le chômage, c\'est non ! Les antifrançais, non ! Arrière !' },
    { time: 179.5, text: 'Mais attention j\'commence à divaguer, j\'vais parler frontières et ce que ça délimite' },
    { time: 183, text: 'Passons rapidement à la suite avant que ça se barre en couille à ma manière' },
    { time: 189, text: 'Les LGBTQIA+, ces grands fous' },
    { time: 192, text: 'T\'es une fille quand t\'as une zaza, t\'es un garçon quand t\'as un zouzou' },
    { time: 196, text: 'Arrêtez de nous faire chier avec tous vos genres qui sortent de la binarité' },
    { time: 199, text: 'Les LGBTQIA+, ces grands fous' },
    { time: 202, text: 'Évidemment, nous savons que vous n\'avez rien sous le caillou' },
    { time: 206, text: 'Mais s\'il vous plaît, ayez un minimum de civilité' },
    { time: 213, text: 'Les woke et la déconstruction, qu\'ai-je bien pus oublier ?' },
    { time: 217, text: 'Oh mon Dieu, mais bien sûr, parlons des gros et de leur body-positivité' },
    { time: 220, text: 'Je suis désolé, mais quand tu pèses 250 kilos, t\'as du diabète' },
    { time: 225, text: 'Et que t\'as du mal à te lever' },
    { time: 227, text: 'C\'est que bien évidemment, t\'es en extrême mauvaise santé' },
    { time: 231, text: '"Oui, nous on peut pas prendre l\'avion car les places sont trop petites"' },
    { time: 239, text: 'Fais pas chier, prends deux places' },
    { time: 241, text: 'Ce n\'est pas nous qui sommes responsables, de la moitié de la consommation de kérosène' },
    { time: 245, text: 'On a encore de la chance qu\'au décollage l\'avion ne fait pas du surplace' },
    { time: 249, text: 'Pourquoi, à ton avis, il n\'y a pas d\'obèses dans les statues gréco-romaines ?' },
    { time: 252, text: 'Encore une fois, tous ces gens s\'inventent un combat qui n\'existe pas' },
    { time: 256, text: 'J\'en ai de plus en plus ras le bol de ces mangeurs de merde' },
    { time: 259, text: 'À chaque discussion et chaque débat je leur dis "Putain, mais je t\'emmerde"' },
    { time: 263, text: 'Car ils sont bloqués dans un idéal' },
    { time: 264, text: 'Alors qu\'en France, c\'est magnifique, il n\'y a aucun débat' },
    { time: 270, text: 'Les LGBTQIA+, ces grands fous' },
    { time: 272, text: 'T\'es une fille quand t\'as une zaza, t\'es un garçon quand t\'as un zouzou' },
    { time: 276, text: 'Arrêtez de nous faire chier avec tous vos genres qui sortent de la binarité' },
    { time: 280, text: 'Les LGBTQIA+, ces grands fous' },
    { time: 282, text: 'Évidemment, nous savons que vous n\'avez rien sous le caillou' },
    { time: 287, text: 'Mais s\'il vous plaît, ayez un minimum de civilité' },
    { time: 296, text: 'Hey, hey, hey' },
    { time: 304, text: 'Hey, hey' },
  ],
