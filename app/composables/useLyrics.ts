...
const localLyricsData: Record<number, LyricLine[]> = {
  ...
  3: [
    ...
    { time: 34, text: 'Vivement qu\'on leur mette des culputes' },
    { time: 38, text: 'Ils sont là, gueulés dans les manifs, enfin on devrait plutôt dire y\'a-le' },
    { time: 44, text: 'Ça a des combats insignifiants, débiles, idiots et superficiels' },
    ...
    { time: 57, text: 'Les LGBT qui a plus, c\'est grand fou' },
    { time: 60, text: 'T\'es une fille quant à une zaza, t\'es un garçon quant à un zouzou' },
    { time: 64, text: 'Arrêtez de nous faire chier avec tous vos genres qui sortent de la binarité' },
    { time: 67, text: 'Les LGBT qui a plus, c\'est grand fou' },
    ...
    { time: 79, text: 'Ok, mais qu\'est-ce que ça veut dire ?' },
    ...
    { time: 92, text: 'Liés à la justice sociale et à l\'égalité rachale' },
    ...
    { time: 103, text: 'Alors excusez-moi, bande de gros gauchos, bande d\'enculés' },
    { time: 107, text: 'Pendant que vous vous battez pour assembler les gens différents' },
    { time: 109, text: 'Nous les fachos, on se bat pour mettre en lumière cette multiculturalité' },
    { time: 114, text: 'Alors que vous vous cachez souillés, brutalisez la culture' },
    { time: 117, text: 'Sur des gens' },
    { time: 118, text: 'Les LGBTQ+, c\'est grand fou' },
    { time: 122, text: 'T\'es une fille quand t\'as une zaza' },
    { time: 125, text: 'T\'es un garçon quand t\'as un zouzou' },
    { time: 127, text: 'Arrêtez de nous faire chier avec tous vos genres qui sortent de la binarité' },
    { time: 130, text: 'Les LGBTQ+, c\'est grand fou' },
    ...
    { time: 147, text: 'Mais la seule chose qui est déconstruite chez moi, c\'est ta mère' },
    { time: 150, text: 'Car l\'idée d\'aller à la cuisine, la penderie et la laverie' },
    { time: 154, text: 'Ça me donne assurément un énorme mal de mère' },
    ...
    { time: 169, text: 'Y\'en aura le bol de perdre l\'argent, tout ça pour aucune récompense derrière' },
    { time: 172, text: 'Nous, ce qu\'on veut, c\'est se faire plaisir' },
    { time: 174, text: 'Mais attention, y\'a des limites' },
    { time: 176, text: 'Les poils, c\'est non' },
    { time: 176, text: 'Le chômage, c\'est non' },
    { time: 177, text: 'Les antifrançais, non' },
    { time: 179, text: 'Arrière, mais attention' },
    { time: 180, text: 'J\'commence à divaguer, j\'vais par les frontières' },
    { time: 182, text: 'Est-ce que ça délimite ?' },
    { time: 183, text: 'Passons rapidement à la suite avant que ça se barre en couille à ma manière' },
    { time: 186, text: 'Les LGBTQ+, c\'est grand fou' },
    { time: 192, text: 'T\'es une fille quand t\'as une zaza' },
    { time: 194, text: 'T\'es un garçon quand t\'as un zouzou' },
    { time: 196, text: 'Arrêtez de nous faire chier avec tous vos genres qui sortent de la binarité' },
    { time: 199, text: 'Les LGBTQ+, c\'est grand fou' },
    ...
    { time: 210, text: 'Les woke et la déconstruction, qu\'ai-je bien plus oublié ?' },
    ...
    { time: 231, text: 'Oui, nous on peut pas prendre l\'avion' },
    { time: 235, text: 'Car les poils, c\'est non' },
    { time: 236, text: 'Les places sont trop petites' },
    { time: 237, text: 'Fais pas chier, prends deux places' },
    { time: 240, text: 'Ce n\'est pas nous qui sommes responsables' },
    { time: 242, text: 'De la moitié de la consommation de kérosène' },
    { time: 244, text: 'On a encore de la chance qu\'au décollage' },
    { time: 247, text: 'L\'avion ne fait pas du surplace' },
    { time: 249, text: 'Pourquoi, à ton avis, il n\'y a pas d\'obèses' },
    { time: 251, text: 'Dans les statues gréco-romaines ?' },
    { time: 252, text: 'Encore une fois, tous ces gens s\'inventent' },
    { time: 254, text: 'Un combat qui n\'existe pas' },
    { time: 256, text: 'J\'en ai de plus en plus ras le bol de ces mangeurs de merde' },
    { time: 258, text: 'À chaque discussion et chaque débat' },
    { time: 261, text: 'Je leur dis putain, mais je t\'emmerde' },
    { time: 263, text: 'Car ils sont bloqués dans un idéal' },
    { time: 264, text: 'Alors qu\'en France, c\'est magnifique' },
    { time: 266, text: 'Il n\'y a aucun débat' },
    { time: 267, text: 'Les LGBT qui a plus, c\'est grand fou' },
    { time: 272, text: 'T\'es une fille quant à une zaza' },
    { time: 275, text: 'T\'es un garçon quant à un zouzou' },
    { time: 276, text: 'Arrêtez de nous faire chier' },
    { time: 278, text: 'Avec tous vos genres qui sortent de la binarité' },
    { time: 280, text: 'Les LGBT qui a plus, c\'est grand fou' },
    { time: 282, text: 'Évidemment, nous savons' },
    { time: 285, text: 'Que vous n\'avez rien sous le caillou' },
    { time: 287, text: 'Mais s\'il vous plaît, ayez un minimum' },
    { time: 289, text: 'De civilité' },
